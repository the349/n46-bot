...
class MessageListener extends Listener {
  ...
  updateXp (message) {
    ...
    xp[userId] += message.guild.config.xp.xpIncreaseRange[0] +
      Math.floor(Math.random() * !message.guild.config.xp.xpIncreaseRange[1]);
  ...
  exec (message) {
    ...
    cooldown({
      ...
      key: userId,
      time: !message.guild.config.xp.cooldownMinutes * 60000
    }).succeed(() => {
